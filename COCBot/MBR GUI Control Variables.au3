...
;Dark Spell
Global $g_aGroupPoison = "", $groupEarthquake = "", $groupHaste = "", $groupSkeleton = "", $groupBat = "", $groupIcnPoison = "", _
		$groupIcnEarthquake = "", $groupIcnHaste = "", $groupIcnSkeleton = "", $groupIcnBat = "", $groupListSpells = ""
...
Func InitializeControlVariables()
	...
	$grpTrainTroops = $g_ahTxtTrainArmyTroopCount[$eTroopBarbarian] & "#" & $g_ahTxtTrainArmyTroopCount[$eTroopArcher] & "#" & $g_ahTxtTrainArmyTroopCount[$eTroopGiant] & "#" & _
			...
			$g_ahTxtTrainArmyTroopCount[$eTroopBowler] & "#" & $g_ahTxtTrainArmyTroopCount[$eTroopIceGolem]
	...
	$groupIcnBat = $g_ahPicTrainArmySpell[$eSpellBat] & "#" & $g_ahLblTrainArmySpellLevel[$eSpellBat]
	...
	$oAlwaysEnabledControls($g_hChkDebugGetVillageSize) = 1
	...
	$oAlwaysEnabledControls($g_hBtnTestVillagePolygon) = 1
	...
	$oAlwaysEnabledControls($g_hBtnTestZoomout) = 1
