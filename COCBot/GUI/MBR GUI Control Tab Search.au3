...
Func chkSpellWaitError()
	...
	If $g_iTotalTrainSpaceSpell > $g_iTotalSpellValue Then  ; we have an error!
				...
				Else
					...
					Switch $iControl
						...
						Case 2
							...
							$sFunnyText = $sText & GetTranslatedFileIni("MBR GUI Control Tab Search", "Func_chkSpellWaitError_FunnyText_02", "Donate ??5000 to MultiBot.run while you wait 15 minutes for this to time out?") & @CRLF
						Case 3
