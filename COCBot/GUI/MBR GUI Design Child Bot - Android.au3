...
Func CreateBotAndroid()
	...
	$g_lblEmulatorReboots = GUICtrlCreateLabel("Emulator Reboots: 0" , $x - 10 , $y + 50)
		GUICtrlSetState($g_lblEmulatorReboots, $GUI_HIDE)
		If FileExists(@ScriptDir & "\EnableMBRDebug.txt") Then GUICtrlSetState($g_lblEmulatorReboots, $GUI_SHOW)
	...
	$x -= 60
		$g_lblHelpBot = GUICtrlCreateLabel("Command line Help ?", $x - 20, $y - 20, 220, 24, $SS_RIGHT)
			...
			_GUICtrlSetTip(-1, "Click here to get help about command line and option for MultiBot.run!")
