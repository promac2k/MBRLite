...
Func CreatePushBulletTelegramSubTab()
	...
	$y += 20
		...
		; Builder Base checkBoxs
		
		;
		

	$y += 95
		$g_hChkNotifyOnlyHours = GUICtrlCreateCheckbox(GetTranslatedFileIni("MBR Global GUI Design", "Only_during_hours", "Only during these hours of each day"), $x + 11, $y )
