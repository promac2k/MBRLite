...
Func CheckTombs()
	If Not TestCapture() Then
		...
		If Not $g_abIsToProccedWith[1] Then
			If $g_bDebugSetlog Then SetDebugLog("Village Don't Need To Check Tombs. Skipping It!", $COLOR_DEBUG)
			Return
		EndIf
	EndIf
	; Timer
