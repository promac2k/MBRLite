...
Func GetButtonDiamond($sButtonName)
	...
	Switch $sButtonName
		...
		Case "ObjectButtons", "BoostOne", "BoostCT" ; Full size of object buttons at the bottom
			$btnDiamond = GetDiamondFromRect("200,529(460,83)") ; RC Done
		...
		Case "Treasury"
			$btnDiamond = "125,530|740,530|740,610|125,610" ; RC Done
		Case "Collect"
		...
		Case "Rearm"
			$btnDiamond = "110,530|730,530|750,615|111,615" ; RC Done
		Case "Research"
			$btnDiamond = "110,530|730,530|750,615|111,615" ; RC Done
		Case Else
