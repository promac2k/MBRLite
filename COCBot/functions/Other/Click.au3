...
Func _DecodeDebug($message)
	...
	Switch $message
		...
		Case "#0000"
			...
			;BuilderBase
		Case "#900"
			Return $separator & "Builder Base - Away"
		Case "#901"
			Return $separator & "Builder Base Found Machine at Field"
		Case "#902"
			Return $separator & "Builder Base Found Wall"
		Case "#903"
			Return $separator & "Builder Base Upgrade Wall"
		Case "#904"
			Return $separator & "Builder Base Confirm Wall"
