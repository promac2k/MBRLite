...
Global $sWatchdogMutex = "MultiBot.run/ManageFarm/" & $API_VERSION

; Register MyBot API Window Message
Global $WM_MYBOTRUN_API = _WinAPI_RegisterWindowMessage("MultiBot.run/API/" & $API_VERSION)
SetDebugLog("MultiBot.run/API/1.1 Message ID = " & $WM_MYBOTRUN_API)

; Register MyBot State Window Message
Global $WM_MYBOTRUN_STATE = _WinAPI_RegisterWindowMessage("MultiBot.run/STATE/" & $API_VERSION)
SetDebugLog("MultiBot.run/STATE/1.1 Message ID = " & $WM_MYBOTRUN_STATE)
