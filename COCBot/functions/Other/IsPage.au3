...
Func IsClanInfoPage()
	...
	Local $result = _ColorCheck(_GetPixelColor(214, 106+ $g_iMidOffsetYNew, True), Hex(0xFFFFFF, 6), 1) And _ColorCheck(_GetPixelColor(815, 58+ $g_iMidOffsetYNew, True), Hex(0xD80402, 6), 5) ; RC Done ; if are not in a clan
	If $result Then
		If $g_bDebugSetlog Or $g_bDebugClick Then SetLog("**Clan Info Window OK**", $COLOR_ACTION)
