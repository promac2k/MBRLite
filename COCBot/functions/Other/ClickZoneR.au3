...
Func ClickZone ($x, $y, $Offset = 7, $debugtxt = "", $times = 1, $speed = 0, $OutScreen = (665 + $g_iBottomOffsetY), $scale = 3, $density = 1, $centerX = 0, $centerY = 0)
	Local $BasY
...
Func ClickR($boundingBox, $x, $y, $times = 1, $speed = 0, $OutScreen = (665 + $g_iBottomOffsetY), $scale = 3, $density = 1, $centerX = 0, $centerY = 0)
...
Func PureClickR($boundingBox, $x, $y, $times = 1, $speed = 0, $OutScreen = (665 + $g_iBottomOffsetY), $scale = 3, $density = 1, $centerX = 0, $centerY = 0)
	Local $AncVal = " ValIn: X=" & $x & " Y=" & $y
	Local Const $PI = 3.141592653589793
	Local $boxWidth = $boundingBox[2] - $boundingBox[0]
	Local $boxHeight = $boundingBox[3] - $boundingBox[1]
...
Func GemClickR($boundingBox,$x, $y, $times = 1, $speed = 0, $debugtxt = "", $OutScreen = (665 + $g_iBottomOffsetY), $scale = 3, $density = 1, $centerX = 0, $centerY = 0)
	Local $AncVal = " ValIn: X=" & $x & " Y=" & $y
	Local Const $PI = 3.141592653589793
	Local $boxWidth = $boundingBox[2] - $boundingBox[0]
	Local $boxHeight = $boundingBox[3] - $boundingBox[1]
