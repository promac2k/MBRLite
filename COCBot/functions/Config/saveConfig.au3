...
Func SaveProfileConfig($sIniFile = Default, $bForceWrite = False)
	...
	IniWrite($sIniFile, "general", "TxtRegistrationToken", $g_sTxtRegistrationToken)
...
Func SaveBuildingConfig()
	...
	_Ini_Add("general", "version", GetVersionNormalized($g_sLiteVersion))
...
Func SaveConfig_Debug()
	...
	_Ini_Add("debug", "DebugGetVillageSize", $g_bDebugGetVillageSize ? 1 : 0)
...
Func SaveConfig_600_6()
	...
	_Ini_Add("other", "ChkUpgradeTroops", $g_bChkUpgradeTroops ? 1 : 0)
	_Ini_Add("other", "ChkUpgradeMachine", $g_bChkUpgradeMachine ? 1 : 0)
	_Ini_Add("other", "CmbBBLaboratory", $g_iCmbBBLaboratory)
