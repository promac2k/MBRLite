...
Func ApplyConfig_Debug($TypeReadSave)
	...
	Switch $TypeReadSave
		Case "Read"
			...
			GUICtrlSetState($g_hChkDebugGetVillageSize, $g_bDebugGetVillageSize ? $GUI_CHECKED : $GUI_UNCHECKED)
			If $g_bDevMode Then
				...
				GUICtrlSetState($g_hChkDebugGetVillageSize, $GUI_ENABLE)
			EndIf
		Case "Save"
			...
			If $g_bDevMode Then
				...
				$g_bDebugGetVillageSize = (GUICtrlRead($g_hChkDebugGetVillageSize) = $GUI_CHECKED)
			EndIf
	EndSwitch
...
Func ApplyConfig_600_1($TypeReadSave)
	...
	Switch $TypeReadSave
		Case "Read"
			...
			GUICtrlSetData($g_hTxtRegistrationToken, $g_sTxtRegistrationToken)
		Case "Save"
			$g_iCmbLogDividerOption = _GUICtrlComboBox_GetCurSel($g_hCmbLogDividerOption)
			; <><><><> Bottom panel <><><><>
			$g_bChkBackgroundMode = (GUICtrlRead($g_hChkBackgroundMode) = $GUI_CHECKED)
			$g_sTxtRegistrationToken = GUICtrlRead($g_hTxtRegistrationToken)
	EndSwitch
...
Func ApplyConfig_600_6($TypeReadSave)
	...
	Switch $TypeReadSave
		Case "Read"
			...
			GUICtrlSetState($g_hChkCTBoostAtkAvailable, $g_bChkCTBoostAtkAvailable ? $GUI_CHECKED : $GUI_UNCHECKED)
			GUICtrlSetState($g_hChkCleanYardBB, $g_bChkCleanYardBB ? $GUI_CHECKED : $GUI_UNCHECKED)
		...
		Case "Save"
			...
			$g_bChkFarmVersion = (GUICtrlRead($g_hChkFarmVersion) = $GUI_CHECKED)
			$g_bChkPlayBBOnly = (GUICtrlRead($g_hChkPlayBBOnly) = $GUI_CHECKED)
			...
			$g_bChkCTBoostAtkAvailable = (GUICtrlRead($g_hChkCTBoostAtkAvailable) = $GUI_CHECKED)
