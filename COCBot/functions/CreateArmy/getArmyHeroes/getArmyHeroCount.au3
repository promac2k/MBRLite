...
Func ArmyHeroStatus($i)
	...
	Local Const $aHeroesRect[3][4] = [[655, 340 + $g_iMidOffsetYNew, 680, 370 + $g_iMidOffsetYNew], [730, 340 + $g_iMidOffsetYNew, 755, 370 + $g_iMidOffsetYNew], [805, 340 + $g_iMidOffsetYNew, 830, 370 + $g_iMidOffsetYNew]] ; RC Done
...
Func LabGuiDisplay() ; called from main loop to get an early status for indictors in bot bottom
	...
	If _ColorCheck(_GetPixelColor(730, 200 + $g_iMidOffsetYNew, True), Hex(0xA2CB6C, 6), 20) Then ; RC Done ; Look for light green in upper right corner of lab window.
		...
		Return True
	ElseIf _ColorCheck(_GetPixelColor(730, 200 + $g_iMidOffsetYNew, True), Hex(0x8088B0, 6), 20) Then ; RC Done ; Look for light purple in upper right corner of lab window.
