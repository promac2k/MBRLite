...
Func getArmyHeroTime($iHeroType, $bOpenArmyWindow = False, $bCloseArmyWindow = False)
	...
	Local Const $aHeroRemainData[3][4] = [[619, 414 + $g_iMidOffsetYNew, "King", $eHeroKing], [691, 414 + $g_iMidOffsetYNew, "Queen", $eHeroQueen], [764, 414 + $g_iMidOffsetYNew, "Warden", $eHeroWarden]] ; RC Done
