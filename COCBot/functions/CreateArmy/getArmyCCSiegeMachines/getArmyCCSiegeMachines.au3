...
Func getArmyCCSiegeMachines($bOpenArmyWindow = False, $bCloseArmyWindow = False, $bCheckWindow = False, $bSetLog = True, $bNeedCapture = True)
	...
	Local $sCCSiegeDiamond = GetDiamondFromRect("620,466,710,544") ; RC Done ; Contains iXStart, $iYStart, $iXEnd, $iYEnd
	...
	Local $sSiegeInfo = getArmyCampCap(650, 438 + $g_iMidOffsetY, $bNeedCapture) ; RC Done ; OCR read Siege built and total
