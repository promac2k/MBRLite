...
Func getArmySiegeMachines($bOpenArmyWindow = False, $bCloseArmyWindow = False, $bCheckWindow = False, $bSetLog = True, $bNeedCapture = True)
	...
	Local $sSiegeDiamond = GetDiamondFromRect("605,171,840,211") ; RC Done ; Contains iXStart, $iYStart, $iXEnd, $iYEnd
	...
	Local $sSiegeInfo = getArmyCampCap(758, 164 + $g_iMidOffsetYNew, $bNeedCapture) ; RC Done ; OCR read Siege built and total
