...
Func LocateTownHall($bLocationOnly = False)
	...
	$g_bRunState = True
	AndroidShield("LocateTownHall 1") ; Update shield status due to manual $g_bRunState
	Local $Result = _LocateTownHall($bLocationOnly)
	$g_bRunState = $wasRunState
	AndroidShield("LocateTownHall 2") ; Update shield status due to manual $g_bRunState
	Return $Result
EndFunc   ;==>LocateTownHall


Func _LocateTownHall($bLocationOnly = False)
