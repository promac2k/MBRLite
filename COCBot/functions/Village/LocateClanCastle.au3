...
Func LocateClanCastle()
	...
	$g_bRunState = True
	AndroidShield("LocateClanCastle 1") ; Update shield status due to manual $g_bRunState
	Local $Result = _LocateClanCastle()
	$g_bRunState = $wasRunState
	AndroidShield("LocateClanCastle 2") ; Update shield status due to manual $g_bRunState
	Return $Result
