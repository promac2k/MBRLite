...
Func TestSmartFarm()
	...
	Local $g_bDebugSmartFarmTemp = $g_bDebugSmartFarm
	$g_bDebugSmartFarm = 1
	...
	$g_bDebugSmartFarm = $g_bDebugSmartFarmTemp
				...
				For $i = 0 To $numberSidesDropTroop - 1
					For $j = 0 To UBound($listInfoDeployTroopPixel) - 1
						...
						Else
							...
							DropOnPixel($infoTroopListArrPixel[0], $pixelDropTroop, $infoTroopListArrPixel[2], $infoTroopListArrPixel[3], True)
						EndIf
