...
Func _GetRedArea($iMode = $REDLINE_IMGLOC, $iMaxAllowedPixelDistance = 25, $fMinSideLengthFactor = 0.65)
	...
	SetDebugLog("TL side length: " & $iSideLength)
	...
	SetDebugLog("BL side length: " & $iSideLength)
	...
	SetDebugLog("TR side length: " & $iSideLength)
	...
	SetDebugLog("BR side length: " & $iSideLength)
