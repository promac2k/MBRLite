...
Global Const $_GUI_BOTTOM_HEIGHT = 135 - $resizerc
...
Func CreateMainGUIControls()
	...
	$g_hFrmBot_MAIN_PIC = _GUICtrlCreatePic($g_sLogoMiniGuiPath, 0, $_GUI_MAIN_TOP, $_GUI_MAIN_WIDTH, 67)
	GUICtrlSetOnEvent(-1, "BotMoveRequest")
