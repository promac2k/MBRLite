...
#pragma compile(ProductName, MultiBot Watchdog)
#pragma compile(Out, MultiBot.run.Watchdog.exe) ; Required
...
Global $g_sBotTitle = "MultiBot Watchdog " & $g_sLiteVersion ;~ Don't use any non file name supported characters like \ / : * ? " < > |
...
If $hMutex_BotTitle = 0 Then
	;MsgBox($MB_OK + $MB_ICONINFORMATION, $sBotTitle, "MultiBot Watchdog is already running.")
